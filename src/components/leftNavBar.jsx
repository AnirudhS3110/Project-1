...
export default function LeftNavBar()
{
  ...
  {
    return(
      <motion.button whileTap={{scale:.95}} className={`flex flex-row w-[100%] justify-start px-[15px] font-semibold py-[10px] rounded-[6px] mr-[10px] transition-colors duration-200  hover:bg-white/40 ${location.pathname === tonav ? "bg-white/70" : "bg-white/0"}`}  onClick={()=>{nav(tonav)}}>
